...
export const THEME_COLORS: ThemeColor[] = [
  ...
  { label: "Turquoise", hue: 170, sat: 80 },
  { label: "Green", hue: 140, sat: 80 },
  { label: "Forest", hue: 130, sat: 75 },
  { label: "Sage", hue: 150, sat: 45 },
  { label: "Lime", hue: 85, sat: 80 },
  { label: "Olive", hue: 60, sat: 65 },
  { label: "Yellow", hue: 50, sat: 95 },
  { label: "Gold", hue: 40, sat: 90 },
  { label: "Amber", hue: 35, sat: 85 },
  { label: "Orange", hue: 30, sat: 95 },
  { label: "Peach", hue: 25, sat: 85 },
  { label: "Red", hue: 0, sat: 85 },
  { label: "Crimson", hue: 348, sat: 90 },
  { label: "Scarlet", hue: 10, sat: 95 },
  { label: "Rose", hue: 345, sat: 80 },
  { label: "Pink", hue: 330, sat: 80 },
  { label: "Salmon", hue: 15, sat: 80 },
  { label: "Magenta", hue: 300, sat: 75 },
  { label: "Violet", hue: 280, sat: 85 },
  { label: "Plum", hue: 290, sat: 60 },
  { label: "Purple", hue: 270, sat: 80 },
  { label: "Lavender", hue: 260, sat: 65 },
  { label: "Indigo", hue: 240, sat: 70 },
  { label: "Slate", hue: 215, sat: 25 },
  { label: "Mint", hue: 160, sat: 65 },
  { label: "Coral", hue: 15, sat: 90 },
  { label: "Brown", hue: 20, sat: 60 },
  { label: "Tan", hue: 30, sat: 40 },
];
